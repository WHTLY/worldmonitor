    ...
    this.ctx.container.innerHTML = `
      ...
      <div class="alliance-promo-bar" id="alliancePromoBar">
        ...
        <div class="alliance-promo-actions">
          ...
          <a class="alliance-promo-action" id="allianceXBtn" href="https://x.com/metabookall" target="_blank" rel="noopener" aria-label="Open X account">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
          </a>
          <a class="alliance-promo-action" id="allianceLinkedInBtn" href="https://www.linkedin.com/company/metaallai/" target="_blank" rel="noopener" aria-label="Open LinkedIn account">
      ...
      <div class="header">
        <div class="header-left">
          ...
          <span class="logo">CONFLICT MONITOR</span><span class="logo-mobile">Conflict Monitor</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
      ...
      <nav class="mobile-menu" id="mobileMenu">
        <div class="mobile-menu-header">
          <span class="mobile-menu-title">CONFLICT MONITOR</span>
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          ...
          <div class="site-footer-brand-text">
            <span class="site-footer-name">CONFLICT MONITOR</span>
            <span class="site-footer-sub">Geo / conflict monitor</span>
          </div>
        </div>
