...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: 'Conflict Monitor - Real-Time Geo & Conflict Dashboard',
    description: 'Real-time geo and conflict dashboard with live news streams, conflict tracking, sanctions, outages, weather alerts, and OSINT signals.',
    keywords: 'conflict monitor, geopolitical dashboard, conflict zones, sanctions tracker, live news streams, OSINT, weather alerts, internet outages, situation awareness, conflict intelligence',
    url: 'https://www.worldmonitor.app/',
    siteName: 'Conflict Monitor',
    shortName: 'Conflict Monitor',
    subject: 'Real-Time Geopolitical Conflict Monitoring and Situation Awareness',
    classification: 'Conflict Dashboard, OSINT Tool, News Aggregator',
